...
/**
 * init - function used to initialize our shell.
 * Return: Always zero
 */
void init()
{
...
/**
 * manageEnviron - Method used to manage the environment variables
 * Return: always zero
 */ 
...
/**
* launchProg - Method for launching a program. It can be run in the background
...
/**
* fileIO - Method used to manage I/O redirection
* Retuen: always zero
*/ 
...
/**
* pipeHandler - Method used to manage pipes.
* Return: alwayz 0
*/ 
